...
% ============================================================
\subsection{Exploratory Data Analysis and GARCH-family Volatility Fitting}
% ============================================================

This section documents the exploratory data analysis (EDA) and the GARCH-family volatility fitting steps that motivate our shock-based modeling framework. We focus on the VIX level and the transformed series
\[
...
\subsubsection{Mean dynamics: best ARIMA for $\Delta \log(\mathrm{VIX})$ (by BIC)}
...
\subsubsection{Volatility dynamics: GARCH$(1,1)$ vs.\ EGARCH$(1,1)$ (Student-\emph{t} innovations)}
...
\subsubsection{Equity market stress and VIX volatility}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{s\&p500_EGARCH_vol.png}
...
The mathematical elegance of the CPP---combined with its empirical out-of-sample validity and practical applicability---makes it an essential tool for volatility risk management.
